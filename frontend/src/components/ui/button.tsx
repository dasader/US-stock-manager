  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97]',
  {
    variants: {
      variant: {
        ...
        gradient: 'bg-gradient-to-r from-primary to-primary/80 text-primary-foreground hover:brightness-110 shadow-sm',
        gradientSuccess: 'bg-gradient-to-r from-emerald-500 to-emerald-600 text-white hover:brightness-110 shadow-sm',
        gradientDanger: 'bg-gradient-to-r from-red-500 to-red-600 text-white hover:brightness-110 shadow-sm',
      },
      size: {
